...
скрытым вводом. Действующий ключ выбранной компании `setup` берёт повторно и
создаёт новый, только если действующих нет.
...
полей, отбор полей `fields`, выбор ключа в `setup`. Сеть при этом не нужна.
